    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {cartItems.length === 0 ? (
        <div className="text-center py-12 bg-white rounded-lg shadow-md">
          <h2 className="text-xl text-gray-600 mb-8">Your cart is empty</h2>
          <Link href="/" className="bg-red-500 text-white px-6 py-3 rounded-md hover:bg-blue-600 transition-colors cursor-pointer">
            Continue Shopping
          </Link>
        </div>
      ) : (
        <>
          ...
          <div className="mt-8 bg-white rounded-lg shadow-md p-6">
            ...
            <div className="flex flex-col sm:flex-col  gap-8">
