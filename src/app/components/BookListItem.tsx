          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="flex-1 min-w-0">
              <Link href={`/book/${book.id}`} className="block group cursor-pointer">
                <h3 className="text-lg font-semibold text-gray-800 truncate group-hover:text-red-600 transition-colors duration-200">
                  {book.title}
                </h3>
            ...
            <div className="flex flex-col items-end gap-3">
              <div className="text-right">
                ...
                {book.featured && (
                  <span className="inline-block bg-red-100 text-red-800 text-xs font-medium px-2 py-1 rounded-full mt-1">
                    Featured
                  </span>
                )}
              </div>
